...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _21485_archive_1.so
_21485_archive_1.so : archive.183/_21485_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -z notext -m elf_i386  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_21485_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_21485_archive_1.so $@


ARCHIVE_OBJS += _prev_archive_1.so
_prev_archive_1.so : archive.183/_prev_archive_1.a
	@$(AR) -s $<
